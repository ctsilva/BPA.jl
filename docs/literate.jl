...
const CHAPTERS = [
    ...
    # Beyond the paper: two steps around the reconstruction, each with its own literature.
    ("normals.jl", "Before the paper: normals from positions", "", ""),
    ("fill.jl", "After the paper: filling small holes", "", ""),
]
